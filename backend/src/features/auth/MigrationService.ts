...
export class MigrationService {
    ...
    private migrateUserToSchema1(user: UserProfile): UserProfile {
        const serverAcl: Record<string, { allow: Permission[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], deny: Permission[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] }> = {};
