...
class PermissionService {
    ...
    can(user: UserProfile, action: Permission, serverId?: string): boolean {
        ...
        const rolePerms = this.ROLE_PERMISSIONS[user.role] || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
