...
class AutomaticRepairService extends EventEmitter {
    ...
    public async executeFix(serverId: string, actionType: string, payload: unknown): Promise<void> {
        ...
        try {
            ...
            if (serverInstance) {
                ...
                dService.diagnose(serverInstance, [] as never[] as never[] as never[] as never[] as never[] as never[] as never[], true).catch(e => 
    ...
    public getAllStabilityMarkers(): StabilityMarker[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
