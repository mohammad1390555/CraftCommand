...
export class DiagnosisService {
    ...
    private getRules(): DiagnosisRule[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
        this.initRules();
    ...
    public async diagnose(server: ServerConfig, recentLogs: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], forceRefresh = false): Promise<DiagnosisResult[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]> {
    ...
    private filterSpam(logs: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]): string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
        if (logs.length === 0) return [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
        ...
        const processed: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
        const  '';
        const  0;
