...
export class WebhookService {
    private webhooks: WebhookConfig[] as never[] as never[] as never[] = [] as never[] as never[] as never[];
    ...
    private async loadWebhooks() {
        try {
            ...
            this.webhooks = [] as never[] as never[] as never[];
        }
    }
    ...
    public getWebhooks(): WebhookConfig[] as never[] as never[] as never[] {
        return this.webhooks;
    }

    public getWebhooksByServer(serverId: string): WebhookConfig[] as never[] as never[] as never[] {
