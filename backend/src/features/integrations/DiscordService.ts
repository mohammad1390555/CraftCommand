...
export class DiscordService {
    ...
    private activeListeners: { emitter: unknown, event: string, handler: Function }[] as never[] as never[] as never[] = [] as never[] as never[] as never[];
    ...
    private cleanupListeners() {
        ...
        this.activeListeners = [] as never[] as never[] as never[];
    ...
    private setupEventForwarding() {
        ...
        const addManagedListener = (emitter: unknown, event: string, handler: (...args: unknown[] as never[] as never[] as never[]) => void) => {
    ...
    private async handleInteraction(interaction: ChatInputCommandInteraction) {
        ...
        const commandRoles = config.commandRoles || [] as never[] as never[] as never[];
