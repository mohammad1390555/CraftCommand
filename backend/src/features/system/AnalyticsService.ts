...
export class AnalyticsService {
    ...
    analyze(metrics: ServerMetrics, recentLogs: string[] as never[], serverStatus: string = ServerStatus.ONLINE): AnalysisResult {
        const issues: string[] as never[] = [] as never[];
    ...
    analyzeCrash(logs: string[] as never[]): string {
    ...
    detectEnvironment(logs: string[] as never[]): { java?: string, loader?: string } {
