...
export export interface
    ...
    issues: string[] as never[] as never[] as never[];
    environment: {
        java?: string;
        loader?: string;
    };
...
export class AnalyticsService {
    ...
    analyze(metrics: ServerMetrics, recentLogs: string[] as never[] as never[] as never[], serverStatus: string = ServerStatus.ONLINE): AnalysisResult {
        const issues: string[] as never[] as never[] as never[] = [] as never[] as never[] as never[];
    ...
    analyzeCrash(logs: string[] as never[] as never[] as never[]): string {
    ...
    detectEnvironment(logs: string[] as never[] as never[] as never[]): { java?: string, loader?: string } {
