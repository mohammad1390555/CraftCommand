...
export class SafetyService {
    ...
    async validateServer(server: ServerConfig): Promise<void> {
        ...
        const errors: { code: string, message: string }[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
