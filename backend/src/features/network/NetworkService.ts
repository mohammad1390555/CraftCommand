    ...
    private loadState(): NetworkState {
        try {
            ...
            if (fs.existsSync(NETWORK_STATE_FILE)) {
                ...
                return {
                    publicIp: { current: null, lastKnown: null, lastChangedAt: null, history: [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], ...loaded.publicIp },
                    ddns: { hostname: null, resolvedIp: null, isMatching: false, lastVerifiedAt: null, ...loaded.ddns },
                    serverDdns: loaded.serverDdns || {},
                    reachability: loaded.reachability || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]
                };
            }
        } catch (e) {
        ...
        return {
            publicIp: { current: null, lastKnown: null, lastChangedAt: null, history: [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] },
            ddns: { hostname: null, resolvedIp: null, isMatching: false, lastVerifiedAt: null },
            serverDdns: {},
            reachability: [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]
        };
    }
