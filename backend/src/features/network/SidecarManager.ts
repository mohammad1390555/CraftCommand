...
export class SidecarManager extends EventEmitter {
     ...
     */
    async startSidecar(serverId: string, type: string, command: string, args: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], cwd: string): Promise<void> {
