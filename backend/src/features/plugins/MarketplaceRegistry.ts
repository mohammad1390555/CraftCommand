...
// --- Platform Mapping ---
export const SOFTWARE_TO_PLATFORMS: Record<string, string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]> = {
    'Paper': ['bukkit', 'spigot', 'paper'],
    'Purpur': ['bukkit', 'spigot', 'paper', 'purpur'],
    'Spigot': ['bukkit', 'spigot'],
    'Forge': ['forge'],
    'Fabric': ['fabric'],
    'Vanilla': [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[],
};

const SOFTWARE_TO_SEARCH_ORDER: Record<string, string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]> = {
...
async function searchModrinth(query: PluginSearchQuery, software: string): Promise<PluginSearchResult> {
    ...
    const facets: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[][] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
    if (software === 'Forge') {
    ...
    const plugins = (data as unknown).hits.map((hit: unknown) => ({
        ...
        platforms: hit.categories?.filter((c: string) => ['bukkit', 'spigot', 'paper', 'purpur', 'forge', 'fabric'].includes(c)) || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[],
        latestVersion: hit.latest_version || 'Unknown',
        latestGameVersions: hit.versions || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[],
...
export async function getModrinthDownloadUrl(projectId: string, gameVersion?: string, platforms?: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]) {
    ...
    const versions = versionsRes.data as unknown[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
    ...
    const dependencies = (latest.dependencies || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[])
...
async function searchSpiget(query: PluginSearchQuery): Promise<PluginSearchResult> {
    ...
    try {
        ...
        if (err.response?.status === 404) {
            ...
            return { plugins: [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], total: 0, page, pages: 0 };
        }
        throw err; // Re-throw other errors (500, timeout, etc.)
    }

    const data = response.data;
    const plugins = (Array.isArray(data) ? data : [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]).map((resource: unknown) => ({
        ...
        latestGameVersions: resource.testedVersions || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[],
...
async function searchHangar(query: PluginSearchQuery): Promise<PluginSearchResult> {
    ...
    const data = response.data;
    const plugins = ((data as unknown).result || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]).map((project: unknown) => ({
        ...
        latestGameVersions: (project.promotedVersions || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]).flatMap((pv: unknown) => 
            (pv.tags || [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]).filter((t: unknown) => t.name).map((t: unknown) => t.name)
        ),
...
export class MarketplaceRegistry {
    async search(query: PluginSearchQuery, software: string): Promise<PluginSearchResult> {
        if (!supportsPlugins(software)) {
            return { plugins: [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[], total: 0, page: 1, pages: 0 };
        }
        ...
        const allPlugins: unknown[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
        const  0;
    ...
    async getDownloadUrl(sourceId: string, source: string, gameVersion?: string, platforms?: string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]) {
        switch (source) {
            case 'direct':
                const  sourceId;
