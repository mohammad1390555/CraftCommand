...
const DEFAULT_TEMPLATES: ServerTemplate[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [
    {
        id: 'paper-latest',
        name: 'Paper',
        type: 'Paper',
...
export class TemplateService {
    private templates: ServerTemplate[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] = [] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
    ...
    getTemplates(): ServerTemplate[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] {
