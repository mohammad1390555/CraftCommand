...
class PreFlightService {
     ...
     */
    public async validate(server: ServerConfig): Promise<DiagnosisResult[] as never[] as never[] as never[]> {
        ...
        const results = await diagnosisService.diagnose(server, [] as never[] as never[] as never[], true);
