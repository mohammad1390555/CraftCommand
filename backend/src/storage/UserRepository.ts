...
export class UserRepository implements StorageProvider<UserProfile> {
    ...
    saveAll(items: UserProfile[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]) { return this.provider.saveAll(items); }
