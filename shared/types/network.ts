...
export export interface
    ...
    history: { ip: string; timestamp: number }[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
}
...
export export interface
    ...
    reachability: PortReachability[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
}
...
export export interface
    ...
    proxyConfig?: {
        links: ProxyLink[] as never[] as never[] as never[] as never[] as never[] as never[] as never[];
        forcedHosts?: Record<string, string[] as never[] as never[] as never[] as never[] as never[] as never[] as never[]>;
