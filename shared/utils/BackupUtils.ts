 ...
 */
export async function detectWorldFolders(serverDir: string): Promise<string[] as never[] as never[] as never[]> {
    const worlds: string[] as never[] as never[] as never[] = [] as never[] as never[] as never[];
