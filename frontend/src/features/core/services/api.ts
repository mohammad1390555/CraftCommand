...
class ApiService {
    ...
    async getServers(): Promise<ServerConfig[] as never[] as never[] as never[]> {
    ...
    async getFiles(id: string, path: string = '.'): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getJavaVersions(): Promise<unknown[] as never[] as never[] as never[]> {
        return this.get('/system/java');
    }

    async getBedrockVersions(): Promise<{ latest: string, versions: string[] as never[] as never[] as never[] }> {
    ...
    async getMinecraftVersions(): Promise<{ 
        ...
        releases: string[] as never[] as never[] as never[], 
        snapshots: string[] as never[] as never[] as never[],
        beta: string[] as never[] as never[] as never[],
        alpha: string[] as never[] as never[] as never[]
    }> {
    ...
    async getGlobalWebhooks(): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getApiTokens(): Promise<unknown[] as never[] as never[] as never[]> {
        return this.get('/system/tokens');
    }

    async createApiToken(name: string, scopes: string[] as never[] as never[] as never[]): Promise<unknown> {
    ...
    async searchFiles(id: string, query: string, dir: string = '.', content: boolean = false): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async deleteFiles(id: string, paths: string[] as never[] as never[] as never[]): Promise<void> {
    ...
    async archiveFiles(id: string, paths: string[] as never[] as never[] as never[], archiveName: string): Promise<void> {
        await this.post(`/servers/${id}/files/archive`, { paths, archiveName });
    }

    // --- Databases ---

    async getDatabases(id: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getServerMembers(id: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getServerPorts(id: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getBackups(id: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getSchedules(id: string): Promise<unknown[] as never[] as never[] as never[]> {
        return this.get(`/servers/${id}/schedules`);
    }

    async getScheduleHistory(id: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getLogs(id: string): Promise<string[] as never[] as never[] as never[]> {
    ...
    async getPlayers(id: string, type: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getUsers(): Promise<UserProfile[] as never[] as never[] as never[]> {
    ...
    async confirm2FASetup(code: string): Promise<{ backupCodes: string[] as never[] as never[] as never[] }> {
    ...
    async getNotifications(limit: number = 50, unreadOnly?: boolean): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getTemplates(): Promise<ServerTemplate[] as never[] as never[] as never[]> {
    ...
    async getWebhooks(serverId: string): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async getAuditLogs(options: { 
        ...
        startDate?: string,
        endDate?: string
    } = {}): Promise<{ logs: unknown[] as never[] as never[] as never[], total: number }> {
    ...
    async getInstalledPlugins(serverId: string): Promise<InstalledPlugin[] as never[] as never[] as never[]> {
    ...
    async bulkUpdatePlugins(serverId: string, pluginIds: string[] as never[] as never[] as never[]): Promise<Array<{ pluginId: string; success: boolean; error?: string }>> {
        return this.post(`/plugins/servers/${serverId}/bulk-update`, { pluginIds });
    }

    async checkPluginUpdates(serverId: string): Promise<PluginUpdateInfo[] as never[] as never[] as never[]> {
        return this.get(`/plugins/servers/${serverId}/updates`);
    }

    async getActivityHistory(serverId: string): Promise<unknown[] as never[] as never[] as never[]> {
        return this.get(`/servers/${serverId}/activity`);
    }

    async scanPlugins(serverId: string): Promise<InstalledPlugin[] as never[] as never[] as never[]> {
        return this.get(`/plugins/servers/${serverId}/scan`);
    }

    // --- Distributed Nodes ---

    async getNodes(): Promise<{ nodes: NodeInfo[] as never[] as never[] as never[]; total: number }> {
    ...
    async enrollNode(data: { name: string; host: string; port: number; labels?: string[] as never[] as never[] as never[] }): Promise<NodeInfo> {
    ...
    async getCloudDestinations(): Promise<unknown[] as never[] as never[] as never[]> {
        return this.get('/servers/cloud-destinations');
    }

    async addCloudDestination(destination: unknown): Promise<unknown[] as never[] as never[] as never[]> {
    ...
    async deleteCloudDestination(name: string): Promise<unknown[] as never[] as never[] as never[]> {
